...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--disable-rpath' '--enable-ipv6' "
                ...
                "'CC=gcc' 'CFLAGS=-Os -fomit-frame-pointer -g' "
                "'LDFLAGS=-Wl,--as-needed' 'CPPFLAGS=-Os -fomit-frame-pointer'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.7m',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/buildozer/aports/main/python3/src/Python-3.7.5/coverage.info',
 'COVERAGE_REPORT': '/home/buildozer/aports/main/python3/src/Python-3.7.5/lcov-report',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   ...
                   '-Wno-missing-field-initializers -Wno-cast-function-type '
                   '-Werror=implicit-function-declaration -fprofile-use '
                   '-fprofile-correction -I. -I./Include -Os '
                   '-fomit-frame-pointer -Os -fomit-frame-pointer -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,--as-needed -Wl,--as-needed -flto -fuse-linker-plugin '
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -Os -fomit-frame-pointer -g -Os '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.7.5',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.7.5 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.7.5 '
 ...
 'abs_builddir': '/home/buildozer/aports/main/python3/src/Python-3.7.5',
 'abs_srcdir': '/home/buildozer/aports/main/python3/src/Python-3.7.5',
